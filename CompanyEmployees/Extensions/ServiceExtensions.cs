...
namespace CompanyEmployees.Extensions
{
    public static class ServiceExtensions
    {
        ...
        public static void ConfigurePostgresqlContext(this IServiceCollection services, IConfiguration configuration) => services.AddDbContext<RepositoryContext>(opts =>
        opts.UseNpgsql(configuration.GetConnectionString("Postgress")));
